...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(r'D:\mycodes\RITH\puer\unet-rgb\paramters\min_loss.pt', map_location=device))
    # model = torch.load(r'D:\mycodes\RITH\puer\unet-rgb\paramters\min_loss.pt')
    model.to(device)
    # model.eval()
    t1 = time.time()
    print("模型加载时间：", t1 - t0)
    roots = r'G:\datas\data\dayi\linescan\20250114yolo_90us_8k\test_pre'
    save_root = r'G:\datas\data\dayi\linescan\20250114yolo_90us_8k\pred'
